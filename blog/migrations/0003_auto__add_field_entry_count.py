...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.count'
        db.add_column(u'blog_entry', 'count',
                      self.gf('django.db.models.fields.TextField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.count'
        db.delete_column(u'blog_entry', 'count')
    ...
    models = {
        ...
        u'blog.entry': {
            ...
            'count': ('django.db.models.fields.TextField', [], {'default': '0', 'max_length': '100'}),
